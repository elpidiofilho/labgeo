...
halarick_descriptor <- function(band, ngrey = 16,  window = c(3,3), shift=list(c(0,1), c(1,1), c(1,0), c(1,-1)),
                                statistics = c('mean', 'mean_ENVI', 'variance', 'variance_ENVI', 'homogeneity',
